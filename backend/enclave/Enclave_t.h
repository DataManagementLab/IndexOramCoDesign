...
sgx_status_t ecall_generic_request(uint8_t* request, uint32_t request_len);
sgx_status_t ecall_run_tests(void);
sgx_status_t ecall_return_oram_path(uint8_t* buckets, uint32_t buckets_len, uint64_t single_bucket_len);
