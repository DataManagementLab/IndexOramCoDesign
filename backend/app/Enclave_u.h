...
#ifndef OCALL_GET_ORAM_BATCH_DEFINED__
#define OCALL_GET_ORAM_BATCH_DEFINED__
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_oram_batch, (uint32_t instance, uint8_t* leaves, uint32_t leaves_len));
#endif
#ifndef OCALL_WRITE_ORAM_BATCH_DEFINED__
#define OCALL_WRITE_ORAM_BATCH_DEFINED__
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write_oram_batch, (uint32_t instance, uint8_t* leaves, uint32_t leaves_len, uint8_t* buckets, uint32_t buckets_len));
#endif
#ifndef OCALL_GENERIC_REQUEST_DEFINED__
#define OCALL_GENERIC_REQUEST_DEFINED__
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_generic_request, (uint8_t* request, uint32_t request_len));
#endif
#ifndef OCALL_SETUP_ORAM_DEFINED__
#define OCALL_SETUP_ORAM_DEFINED__
sgx_status_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_setup_oram, (uint32_t instance, uint32_t offset, uint8_t* buckets, uint32_t buckets_len));
#endif
